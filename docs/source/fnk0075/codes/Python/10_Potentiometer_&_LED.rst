...
Open "Thonny", click "This computer" -> "D:" -> "Micropython_Codes" -> "09.2_Color_Light" and double click "Color_Light.py".
...
.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/09.2_Color_Light/Color_Light.py
    :linenos: 
    :language: python
    :lines: 1-26
    :dedent:
